...
template<> struct PropertyType<ThingPropertyKey::voltage>  { using type = ElectricValue; };
template<> struct PropertyType<ThingPropertyKey::current>  { using type = ElectricValue; };
